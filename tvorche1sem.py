...
def calories(weight, activity, duration):  # A5
    ...
    try:
        ...
        if choice == 0:
            ...
            client = Client(random.choice(names), age, random.randint(3000, 50000),
                            ...
                            random.choice(["здорова", "слабка", "повільна", "товста", "худа"]),
